...
| Проблема | Файл | Описание |
|----------|------|-----------|
| Дублирование sha256 функции | `server/src/main/kotlin/com/mobilemoney/server/HashUtil.kt`, `AuthService.kt:51` | Функция определена 2 раза, использует SHA-512 но названа sha256 |
